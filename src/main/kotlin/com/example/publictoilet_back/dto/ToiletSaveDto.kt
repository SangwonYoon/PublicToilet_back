...
class ToiletSaveDto(
        ...
        @ApiModelProperty(value = "개방 시작 시간") val openTime : String?,
        @ApiModelProperty(value = "개방 마감 시간") val closeTime : String?,
    ...
    fun toEntity() : Toilet {
        return Toilet(longitude = longitude, latitude = latitude, toiletName = toiletName, tel = tel, openTime = LocalTime.parse(openTime, DateTimeFormatter.ofPattern("HH:mm:ss")), closeTime = LocalTime.parse(closeTime, DateTimeFormatter.ofPattern("HH:mm:ss")), mw = mw, m1 = m1, m2 = m2, m3 = m3, m4 = m4, m5 = m5, m6 = m6, w1 = w1, w2 = w2, w3 = w3)
    }
}